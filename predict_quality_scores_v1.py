...
import time
from utilities import extract_patches_gdal
...
def calculate_qs(tiles_json_file, w_path, json_name, model_file):
    ...
    for tile in tiles_list:
        patches, indexes = extract_patches_gdal(tile=tile['image_name'], patch_size=[512, 512])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_name', default='quality_scores_1_gdal')
